            ...
            if (jsonString.length > 0) {
                ...
                if (message.request.type == "IntentRequest") {
                    if (!message.request.intent.slots.word.value) {
                        ...
                        if (word.toLowerCase() == "puppies") {
                            myanswer = "Puppies are very cute!"
                        }

                        if (word.toLowerCase() == "weather") {
                            myanswer = "It is going to be hot tomorrow so you might want to wear shorts!"
                        }
                    }
